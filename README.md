...
from flask_wechat_utils.routes import bp as wechat_user_auth_bp
from flask_wechat_utils.models import db as wechat_user_auth_db
...
app.register_blueprint(wechat_user_auth_bp)
